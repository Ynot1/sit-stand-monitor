  ...
  * make a function to display rectangles as a graph from an array of data
  * 
  ...
  *   could i dispaly contents of the working/sittiong time array as a bar graph? Hourly on daily page, daily on weekly page
  *   
